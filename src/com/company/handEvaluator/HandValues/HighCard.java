...
public class HighCard implements Evaluator {
    ...
    public Hand evaluate(){
        //Initialize winner com.company.hand to null
        Hand winner = null;
        ...
        int hand2Fourth = 0;
        int hand2Fifth = 0;
        //Iterate through com.company.hand and assign rankings
        for(int i=0; i<5; i++) {
            Card hand1i = (Card) hand1.getHand().get(i);
            Card hand2i = (Card) hand2.getHand().get(i);
            //determine com.company.hand 1's values
            ...
            //determine com.company.hand 2's values
        ...
        //determine the high com.company.card winner
