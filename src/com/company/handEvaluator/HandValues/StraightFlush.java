 ...
 * If they're both a flush then we rank them by the sum of the mapNum(com.company.card number) values.
 * **/
public class StraightFlush implements Evaluator {
    private Hand hand1;
    private Hand hand2;
    ...
    public Hand evaluate(){
        ...
        //test if white com.company.hand has all cards of the same suit
        //we're also adding the values of the number's of each com.company.hand (according to the mapNum(com.company.card number) value
        //in case each com.company.hand is a flush to determine the winner
        for(int i=1; i<5; i++) {
        ...
        //if both are straight flushes, then we need to see which com.company.hand has a higher com.company.card value
