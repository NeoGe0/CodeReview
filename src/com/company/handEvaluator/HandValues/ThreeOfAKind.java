...
public class ThreeOfAKind implements Evaluator {
    ...
    public Hand evaluate(){
        ...
        if(hand1SameValueCounter > 2){
            //if we have more than 3 of the same com.company.card in the com.company.hand it is not a fourth!
        ...
        if(hand1SameValueCounter == 2 && hand2SameValueCounter == 2) {
            ...
            //since it is guaranteed that our decks are sorted lowest to highest we can pull the first com.company.card and compare
