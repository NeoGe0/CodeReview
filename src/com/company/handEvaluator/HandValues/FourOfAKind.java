...
public class FourOfAKind implements Evaluator {
    ...
    public Hand evaluate(){
        ...
        //initialize booleans that tell if a com.company.hand is a flush or not
        boolean hand1Flush = false;
        boolean hand2Flush = false;
        //If both hands are flush then we see which com.company.hand has the higher value
        //this is consistent with the HighCard evaluation method and will be substituted
        //with HighCard in the future. TODO substitute with high com.company.card
        int hand1Value = ((Card) (hand1.getHand().get(0))).enumToInt();
        int hand2Value = ((Card) (hand2.getHand().get(0))).enumToInt();
        /**
         * Iterate through each com.company.hand.
         * Compare com.company.hand[i] with com.company.hand[i-1]
         */
        for(int i=1; i<5; i++){
            // pull com.company.card at hand1[i]
            Card h1i = (Card)(hand1.getHand().get(i));
            // pull com.company.card at hand1[i-1]
            Card h1iMinusOne = (Card)(hand1.getHand().get(i-1));
            // pull com.company.card at hand2[i]
            Card h2i = (Card)(hand2.getHand().get(i));
            //pull com.company.card at hand2[i-1]
            ...
            //Add the com.company.hand values in case we need a HighCard evaluation
